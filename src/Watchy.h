...
typedef struct watchyAlarm { // Struct of Alarm
  int8_t hour;
  int8_t minute;
  int8_t day;
  int8_t month;
...
extern RTC_DATA_ATTR watchyAlarm myAlarm; // Alarm
extern RTC_DATA_ATTR NavMode navMode;
