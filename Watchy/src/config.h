...
#define MARGIN_R   8
#define MARGIN_T   16
#define MARGIN_B   10  // veći top (ram „seče” par px)

#define LEFT_X           MARGIN_L
#define RIGHT_X          DISPLAY_WIDTH - MARGIN_R
#define TOP_Y            MARGIN_T
#define BOT_Y            DISPLAY_HEIGHT - MARGIN_B


// Task Table
#define NAME_COL_W       56
#define VCOLS            4
#define CELL_W           (RIGHT_X - LEFT_X - NAME_COL_W) / VCOLS // ravnomerno
#define ROW_H            27
#define HEADER_Y         TOP_Y + 10
#define VROWS            3
